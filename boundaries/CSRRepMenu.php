...
.create-btn:hover {
    ...
    <title>CSR Representative Menu</title>
</head>
<body>

    <h1>CSR Representative Menu</h1>

    <div class="navbar">
        <button 
            class="<?php echo ($_GET['action'] ?? '') === '2_CSRRep_Menu' ? 'selected' : '' ?>" 
            onclick="window.location='index.php?action=2_CSRRep_Menu'">
            Requests
        </button>

        <button 
            class="<?php echo ($_GET['action'] ?? '') === 'CSRRepShortlistedRequestsPage' ? 'selected' : '' ?>" 
            onclick="window.location='index.php?action=CSRRepShortlistedRequestsPage'">
            Shortlisted Requests
        </button>

        <button 
            class="<?php echo ($_GET['action'] ?? '') === 'CSRRepCompletedMatchHistoryPage' ? 'selected' : '' ?>" 
            onclick="window.location='index.php?action=CSRRepCompletedMatchHistoryPage'">
