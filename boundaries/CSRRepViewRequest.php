<?php
// boundaries/CSRRepViewRequest.php
...
$request = $CSRRepViewRequestController->GetRequestByID($rID);

// increment view count by one
$CSRRepViewRequestController->IncrementRequestViewCount($rID);
...
<body>
    ...
    <div class="request-container">
        ...
        <button class="back-button" onclick="window.location.href='../index.php?action=2_CSRRep_Menu';">Back</button>
    </div>
</body>
</html>
