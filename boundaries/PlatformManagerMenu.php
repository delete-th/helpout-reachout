<?php
// boundaries/PlatformManagerMenu.php
session_start();
?>
<html>
<head>
    <title>Platform Manager Menu</title>
    <style>
h1 {
    margin-bottom: 20px;
}
...
.create-btn:hover {
    ...
    <script>
		function goToCreateCategoryForm() {
			window.location.href = 'boundaries/CategoryCreateForm.php';
		}
		
    </script>
</head>
<body>
    <h1>Platform Manager Menu</h1>
	...
	<!-- Create Button -->
	<a onclick="goToCreateCategoryForm()" class="create-btn">+ Create New Category</a>
