...
.create-btn:hover {
    ...
    <script>
        function goToCreateRequest() {
            window.location.href = 'boundaries/PINRequestCreateForm.php';
        }
...
<body>
    ...
    <div class="navbar">
        <button 
            class="<?php echo ($_GET['action'] ?? '') === '1_PIN_Menu' ? 'selected' : '' ?>" 
            onclick="window.location='index.php?action=1_PIN_Menu">
            My Requests
        </button>

        <button 
            class="<?php echo ($_GET['action'] ?? '') === 'PIN_History' ? 'selected' : '' ?>" 
            onclick="window.location='index.php?action=PIN_History'">
            Match History
        </button>
    ...
    <a onclick="goToCreateRequest()" class="create-btn">+ Create New Request</a>
